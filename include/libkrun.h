...
#define NET_VFLAG_GUEST_CSUM 1 << 1
#define NET_VFLAG_GUEST_TSO4 1 << 7
#define NET_VFLAG_GUEST_TSO6 1 << 8
#define NET_VFLAG_GUEST_UFO 1 << 10
#define NET_VFLAG_HOST_TSO4 1 << 11
#define NET_VFLAG_HOST_TSO6 1 << 12
#define NET_VFLAG_HOST_UFO 1 << 14
/**
 ...
 *  "vflags"  - virtio-net flags for the network interface.
 *
 * Notes:
