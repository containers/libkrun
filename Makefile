...
GENERATED_COMMENT_C = /* @generated by: make gen-init-blob-bindings — do not edit manually. */
GENERATED_COMMENT_RS = // @generated by: make gen-init-blob-bindings — do not edit manually.

gen-init-blob-bindings:
	cargo build -p krun-init-blob-cdylib
	{ echo '$(GENERATED_COMMENT_C)'; cargo run --bin krun-init-blob-gen c-header; } > $(LIBRARY_HEADER_INIT)
	{ echo '$(GENERATED_COMMENT_RS)'; echo '$(FFIER_ALLOWS)'; cargo run --bin krun-init-blob-gen rust-client; } > init/init-blob-via-cdylib/src/lib.rs
	{ echo '$(GENERATED_COMMENT_RS)'; echo '$(FFIER_ALLOWS)'; cargo run --bin krun-init-blob-gen rust-client --weak; } > init/init-blob-via-cdylib-weak/src/lib.rs
