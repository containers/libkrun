...
#[cfg(feature = "net")]
const NET_VFLAG_CSUM: u32 = 1 << 0;
#[cfg(feature = "net")]
const NET_VFLAG_GUEST_CSUM: u32 = 1 << 1;
#[cfg(feature = "net")]
const NET_VFLAG_GUEST_TSO4: u32 = 1 << 7;
#[cfg(feature = "net")]
const NET_VFLAG_GUEST_TSO6: u32 = 1 << 8;
#[cfg(feature = "net")]
const NET_VFLAG_GUEST_UFO: u32 = 1 << 10;
#[cfg(feature = "net")]
const NET_VFLAG_HOST_TSO4: u32 = 1 << 11;
#[cfg(feature = "net")]
const NET_VFLAG_HOST_TSO6: u32 = 1 << 12;
#[cfg(feature = "net")]
const NET_VFLAG_HOST_UFO: u32 = 1 << 14;
/*
 ...
 */
#[cfg(feature = "net")]
const NET_COMPAT_VFLAGS: u32 = NET_VFLAG_CSUM
    | NET_VFLAG_GUEST_CSUM
    | NET_VFLAG_GUEST_TSO4
    | NET_VFLAG_GUEST_UFO
    | NET_VFLAG_HOST_TSO4
    | NET_VFLAG_HOST_UFO;
#[cfg(feature = "net")]
const NET_ALL_VFLAGS: u32 = NET_VFLAG_CSUM
    | NET_VFLAG_GUEST_CSUM
    | NET_VFLAG_GUEST_TSO4
    | NET_VFLAG_GUEST_TSO6
    | NET_VFLAG_GUEST_UFO
    | NET_VFLAG_HOST_TSO4
    | NET_VFLAG_HOST_TSO6
    | NET_VFLAG_HOST_UFO;
...
pub unsafe extern "C" fn krun_add_net_unixstream(
    ...
    match CTX_MAP.lock().unwrap().entry(ctx_id) {
        Entry::Occupied(mut ctx_cfg) => {
            let cfg = ctx_cfg.get_mut();
            create_virtio_net(cfg, backend, mac, vflags);
        }
        Entry::Vacant(_) => return -libc::ENOENT,
    }
    KRUN_SUCCESS
