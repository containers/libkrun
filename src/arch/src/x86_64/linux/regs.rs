...
use super::super::layout::{BOOT_STACK_POINTER, RESET_VECTOR_SEV_AP, ZERO_PAGE_START};
...
#[cfg(test)]
mod tests {
    use super::super::super::layout::{BOOT_STACK_POINTER, ZERO_PAGE_START};
    ...
    fn validate_page_tables(gm: &GuestMemoryMmap, cr3: u64, cr4: u64, cr0: u64) {
        use super::super::super::regs::{X86_CR0_PG, X86_CR4_PAE};
        let pml4_start: u64 = 0x9000;
        let pdpte_start: u64 = 0xa000;
        let pde_start: u64 = 0xb000;
