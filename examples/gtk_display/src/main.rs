use crate::gtk_display::DisplayBackendHandle;
use clap::Parser;
use clap_derive::Parser;
use krun_sys::{
    VIRGLRENDERER_THREAD_SYNC, VIRGLRENDERER_USE_ASYNC_FENCE_CB, VIRGLRENDERER_USE_EGL,
    krun_create_ctx, krun_set_display, krun_set_display_backend, krun_set_exec,
    krun_set_gpu_options, krun_set_log_level, krun_set_root, krun_start_enter,
};
use log::LevelFilter;
...
fn main() -> anyhow::Result<()> {
    ...
    let (display_backend, display_worker) = gtk_display::crate_display();
